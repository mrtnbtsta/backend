...
if(isset($_POST["name"])){
    ...
    if(move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)){
        ...
        if($stmt->execute()){
            ...
            $stmt = $con->prepare("INSERT INTO reports (rdid ,typeOfReport, describeIncident, locationIncident, image, type) VALUES(?,?,?,?,?,?)");
            $stmt->bind_param("isssss", $last_id ,$typeOfReport, $describeIncident, $locationIncident, $image, $type);
            $stmt->execute();
