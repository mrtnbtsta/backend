...
$stmt= $con->prepare("SELECT asr.month_text, r.type, asr.start_date, asr.end_date FROM admin_summary_report asr INNER JOIN reports r ON r.rid = asr.rid WHERE asr.start_date <= NOW() AND r.type='Emergency' GROUP BY asr.month_text");
