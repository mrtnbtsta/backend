...
$stmt = $con->prepare("SELECT * FROM lost_found_claim lfc LEFT JOIN lost_found lf ON lfc.id = lf.id LEFT JOIN users u ON lf.uid = u.uid WHERE lfc.status='0' AND lf.status_claim='0' AND lfc.seen='0'");
