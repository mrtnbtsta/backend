...
$stmt= $con->prepare("SELECT r.typeOfReport, count(r.typeOfReport) as type_count FROM admin_summary_report asr INNER JOIN reports r ON r.rid = asr.rid GROUP BY r.typeOfReport");
